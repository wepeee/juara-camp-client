...
"[project]/app/component/user/UserDashboard.tsx [app-ssr] (ecmascript)": ((__turbopack_context__) => {
"use strict";
...
const UserDashboard = ()=>{
    ...
    const getKelas = async ()=>{
        try {
            ...
            const respond = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].get("http://localhost:8080/api/kelas", {
                headers: {
    ...
    const buyHandler = async (idKelas)=>{
        try {
            ...
            const decoded = JSON.parse(atob(token.split(".")[1]));
            const respond = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$axios$2f$lib$2f$axios$2e$js__$5b$app$2d$ssr$5d$__$28$ecmascript$29$__["default"].post("http://localhost:8080/api/user/kelas", {
                kelasId: idKelas,
                id: decoded.id
            }, {
                headers: {
...
"[project]/app/dashboard/@user/page.tsx [app-rsc] (ecmascript, Next.js server component, client modules ssr)": ((__turbopack_context__) => {
...
//# sourceMappingURL=%5Broot%20of%20the%20server%5D__d5bb9b._.js.map